...
document.querySelectorAll(".product").forEach((item) => {
  item.addEventListener("touchstart", (e) => {
    ...
    item.style.transition = "none"; // Отключаем анимацию, чтобы избежать скачков
...
function onTouchMove(e) {
  ...
  draggedElement.style.left = offsetX + deltaX + "px";
  draggedElement.style.top = offsetY + deltaY + "px";
}
...
function onTouchEnd() {
  if (draggedElement) {
    ...
    // Останавливаем движение и включаем плавную анимацию
